...
- 左键点击菜单栏图标查看验证码，点击账号复制当前有效码并关闭菜单；菜单底部可打开设置或退出。
- 设置列表中的「菜单栏显示」开关控制每个账号是否出现在菜单中，重启后保留选择；隐藏账号仍可在设置中查看、编辑和复制。
- 右键点击图标也可打开设置或退出；关闭设置窗口后仍驻留菜单栏。
...
- [A1 界面与逐账号菜单栏显示](https://github.com/Erugihs/otpbar/issues/5)
